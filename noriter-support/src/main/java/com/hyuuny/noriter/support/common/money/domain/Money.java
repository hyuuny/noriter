package com.hyuuny.noriter.support.common.money.domain;
...
public class Money extends Number implements Comparable<BigDecimal> {
    ...
    public Money divideByFloor(double divisor) {
        return new Money(amount.divide(BigDecimal.valueOf(divisor), 2, RoundingMode.FLOOR));
    }
